    ...
    <div className="flex h-screen bg-background">
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="flex justify-between items-center p-6 border-b">
          <div>
            <h1 className="text-3xl font-bold text-foreground">AI Learning Assistant</h1>
            <p className="text-muted-foreground mt-1">Generate personalized courses with AI Professor</p>
          </div>
          <ModeToggle />
        </header>
